...
export const StoreButton = ({ handleClick, loading }: StoreButtonProps) => {
  return (
    <button
      ...
      type="button"
      disabled={loading}
      className="plasmo-relative plasmo-flex plasmo-flex-row plasmo-items-center plasmo-rounded-lg plasmo-transition-all plasmo-border-none plasmo-shadow-lg hover:plasmo-shadow-md active:plasmo-scale-105 plasmo-bg-slate-50 hover:plasmo-bg-slate-100 plasmo-opacity-50 hover:plasmo-opacity-100">
